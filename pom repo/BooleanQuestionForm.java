...
public class BooleanQuestionForm extends BaseClass {
	
WebDriver driver;

	public  BooleanQuestionForm(WebDriver driver){
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}
		
	public void BooleanQuestion(int a, int b) throws Throwable, IOException {	
		//Question
	...
	public void booleantype() {
		WebElement booleanType=driver.findElement(By.xpath("//li[@data-value='boolean']"));
		booleanType.click();
