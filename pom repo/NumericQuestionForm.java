...
public class NumericQuestionForm extends BaseClass{
	
	WebDriver driver;

	public  NumericQuestionForm(WebDriver driver){
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}
	public void NumericQuestion(int a, int b) throws Throwable, IOException {	
	...
	public void numerictype() throws Throwable {
		WebElement textType=driver.findElement(By.xpath("//li[@data-value='numeric']"));
		textType.click();
