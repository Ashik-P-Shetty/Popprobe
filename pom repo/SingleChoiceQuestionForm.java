...
public class SingleChoiceQuestionForm extends BaseClass {

	WebDriver driver;

	public  SingleChoiceQuestionForm(WebDriver driver){
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}
	public void SingleChoiceQuestion(int a,int b) throws Throwable, IOException {	
	...
	public void singlechoicetype() throws Throwable {
		//To select single choice type
		WebElement textType=driver.findElement(By.xpath("//li[@data-value='singlechoice']"));
